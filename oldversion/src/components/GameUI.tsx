...
export function GameHUD() {
  ...
  return (
    <div className="game-hud">
      ...
      {/* CV Controller - only show when needed */}
      {cvControlEnabled && !cvError && showCameraControls && (
        <CVController
          enabled={cvControlEnabled}
          onPrediction={handleCVPrediction}
          onReturnToMenu={handleStartGame}
